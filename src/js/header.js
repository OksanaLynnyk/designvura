document.addEventListener('DOMContentLoaded', () => {
  ...
  function highlightCurrentLink() {
    ...
    const isIndexPage = currentPath === '/index.html' || currentPath === '' || currentPath === '/';
    ...
    menuLinks.forEach(link => {
      ...
      link.classList.remove('active-true');

      if (!linkHash && linkPath === currentPath && !currentHash) {
        link.classList.add('active-true');
      }
      else if (isIndexPage && linkHash && linkHash === currentHash) {
        link.classList.add('active-true');
      }
      else if (isIndexPage && !linkHash && !currentHash) {
